...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/workspaces/tts-django-404318-1827d7040649.json"
...
INSTALLED_APPS = [
    ...
    "corsheaders", #allow request from another domain
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000",  # Adjust this to your frontend origin
]
